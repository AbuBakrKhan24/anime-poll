<template>
  <div class="first">
    <img
      src="http://pre12.deviantart.net/91c4/th/pre/i/2012/064/9/a/uzumaki_naruto_vs_uchiha_sasuke_by_xabracadabra-d4rsna5.jpg"
    />
  </div>
  ...
  />
  <div class="bg">
    <h1>Hope you enjoy your time spent on this website</h1>
  </div>
</template>
<script>
export default {};
...
.bg {
  ...
  bottom: 0;
  left: 0;
  background: url("https://3.bp.blogspot.com/_ImecizcBRRU/TS6TU8NQ95I/AAAAAAAABdE/FRG5NyHoGR4/s1600/naruto_016-017.png");
...
.logo:nth-child(1) {
  ...
  background: url("http://images5.fanpop.com/image/photos/28800000/Manga-naruto-shippuuden-28820722-1299-938.jpg");
  background-size: 2000px auto;
